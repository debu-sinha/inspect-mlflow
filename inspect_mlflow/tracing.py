...
Activated automatically when both MLFLOW_TRACKING_URI and
MLFLOW_INSPECT_TRACING="true" are set.
"""
...
class MlflowTracingHooks(Hooks):
    ...
    async def on_sample_end(self, data: SampleEnd) -> None:
        ...
        try:
            ...
            if sample.scores:
                outputs["scores"] = {name: score.value for name, score in sample.scores.items()}
